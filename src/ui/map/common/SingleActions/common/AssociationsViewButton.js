...
/**
 * Use `AssociationsViewButton` to
 * Has color `x`
 */
const AssociationsViewButton = ({
  id,
  className,
  style,
  item,
...
AssociationsViewButton.propTypes = {
  /**
...
/*
AssociationsViewButton.defaultProps = {
  status: 'neutral',
  //height:'2.2em',
  //as:'p',
}
*/
export default AssociationsViewButton
